      ...
      >
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Truemark top management ensures that operations are conducted to safeguard objectivity and impartiality in delivering certification services in a non-discriminatory manner.</li>
            ...
            <li>Truemark shall not offer consultancy or suggest certification will be easier through certain individuals or services.</li>
            <li>Certification decisions shall be made independently of the assessment process.</li>
            <li>Ongoing monitoring of conformance to this policy is part of Truemark's risk and quality management system.</li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            Truemark commits to acting impartially in relation to its applicants, candidates, and certified persons. All certification decisions shall follow clearly defined policies and procedures.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Truemark understands and actively manages threats to impartiality including self-interest, personnel relationships, financial pressure, favoritism, conflict of interest, or intimidation.</li>
            ...
            <li>Truemark ensures that its operations are compliant with ISO/IEC 17024:2012 and relevant conformity assessment guidelines.</li>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 italic">
          This policy shall be reviewed annually or upon significant changes to Truemark's certification operations.
        </p>
      </motion.div>
    </section>
  );
