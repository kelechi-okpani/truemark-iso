...
const EnrolledCourseVideoItem = ({ courseListing, module }: VideoItemProps) => {
  ...
  // Sync Redux state when the user interacts with the native player
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-video bg-slate-900 overflow-hidden">
        <video
          src={video}
          poster={module?.image || courseListing?.image}
          controls // Browser handles play/pause/fullscreen/volume
        ...
        {/* ISO Status Badge (Visual only) */}
        {isActive && (
          <div className="absolute top-3 left-3 pointer-events-none flex items-center gap-1.5 bg-[#387467]/90 backdrop-blur-sm text-white px-3 py-1 rounded-full shadow-lg z-10">
      ...
      <div className="p-5 space-y-3">
        ...
        <p className="text-xs text-gray-500 font-medium leading-relaxed line-clamp-2">
          {description || "Technical training resource for ISO certification standards."}
        </p>
